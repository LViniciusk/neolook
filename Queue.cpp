...
iterator_queue<Type>::iterator_queue(Node<Type> *ptr) { m_ptr = ptr; }
...
template <typename Type>
Type& iterator_queue<Type>::operator*() { return m_ptr->data; }
...
template <typename Type>
void Queue<Type>::clear() { delete m_head; }
template <typename Type>
...
template <typename Type>
iterator_queue<Type> Queue<Type>::begin() { return iterator_queue<Type>(m_head); }
template <typename Type>
iterator_queue<Type> Queue<Type>::end() { return iterator_queue<Type>(m_tail->next); }
